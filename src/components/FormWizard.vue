<template>
  <div>
    <div v-if="wizardInProgress" v-show="asyncState !== 'pending'">
      <keep-alive>
        <component ref="currentStep" :is="currentStep" @update="processStep" :wizard-data="form" @updateAsyncState="updateAsyncState"></component>
      </keep-alive>
      ...
      <div class="buttons">
        ...
        <button @click="nextButtonAction" :disabled="!canGoNext" class="btn">{{ isLastStep ? 'Complete Order' :
        'Next'}}</button>
      </div>
    </div>
